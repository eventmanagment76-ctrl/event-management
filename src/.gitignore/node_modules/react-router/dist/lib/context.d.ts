...
import type { AgnosticIndexRouteObject, AgnosticNonIndexRouteObject, AgnosticRouteMatch, History, LazyRouteFunction, Location, Action as NavigationType, RelativeRoutingType, Router, StaticHandlerContext, To, TrackedPromise } from "@remix-run/router/dist";
...
export declare const DataRouterStateContext: React.Context<import("@remix-run/router/dist").RouterState | null>;
