...
import AtRule, { AtRuleProps } from 'postcss/lib/at-ruleat-rule.js'
import Comment, { CommentProps } from 'postcss/lib/commentcomment.js'
import Container, { ContainerProps, NewChild } from 'postcss/lib/containerntainer.js'
import CssSyntaxError from 'postcss/lib/css-syntax-errorx-error.js'
import Declaration, { DeclarationProps } from 'postcss/lib/declarationaration.js'
import Document, { DocumentProps } from 'postcss/lib/document.js'
import Input, { FilePosition } from 'postcss/lib/inputb/input.js'
import LazyResult from 'postcss/lib/lazy-result-result.js'
import list from 'postcss/lib/listib/list.js'
import Node, {
  AnyNode,
  ChildNode,
  ChildProps,
  ...
  Position,
  Source
} from 'postcss/lib/nodeib/node.js'
import Processor from 'postcss/lib/processorocessor.js'
import Result, { Message } from 'postcss/lib/result/result.js'
import Root, { RootProps } from 'postcss/lib/rootib/root.js'
import Rule, { RuleProps } from 'postcss/lib/ruleib/rule.js'
import Warning, { WarningOptions } from 'postcss/lib/warningwarning.js'
